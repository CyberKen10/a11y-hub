...
insert into public.knowledge_types (slug, name, description, icon, sort_order, fields) values
  ...
  ('estandares', 'Estándares y normativas', 'WCAG, EN 301 549, ADA, Ley Europea de Accesibilidad y más.', 'scale', 3,
   '[{"key":"version","label":"Versión","kind":"text"},{"key":"jurisdiccion","label":"Jurisdicción","kind":"text"},{"key":"official_url","label":"URL oficial","kind":"url"}]'::jsonb),
  ('patrones', 'Patrones y prácticas', 'Patrones de diseño y desarrollo accesible.', 'puzzle', 4,
   '[{"key":"wcag_refs","label":"Criterios WCAG","kind":"list"},{"key":"code_notes","label":"Notas de implementación","kind":"textarea"}]'::jsonb),
  ('herramientas', 'Herramientas', 'Herramientas de testing, auditoría y desarrollo.', 'wrench', 5,
   '[{"key":"vendor","label":"Proveedor","kind":"text"},{"key":"pricing","label":"Licencia / precio","kind":"text"},{"key":"url","label":"Sitio web","kind":"url"}]'::jsonb),
  ('casos-de-estudio', 'Casos de estudio', 'Proyectos y auditorías reales con aprendizajes.', 'briefcase', 6,
   '[{"key":"client","label":"Cliente / contexto","kind":"text"},{"key":"outcome","label":"Resultado","kind":"textarea"}]'::jsonb),
  ('investigacion', 'Investigación y evidencia', 'Estudios, papers y hallazgos con usuarios.', 'flask-conical', 7,
   '[{"key":"authors","label":"Autores","kind":"text"},{"key":"year","label":"Año","kind":"text"},{"key":"url","label":"Enlace","kind":"url"}]'::jsonb),
  ('plantillas', 'Plantillas', 'Plantillas de informes, checklists y documentos.', 'file-text', 8,
   '[{"key":"format","label":"Formato","kind":"text"}]'::jsonb),
  ('glosario', 'Glosario', 'Términos de accesibilidad y sus definiciones.', 'book-open', 9,
   '[]'::jsonb),
  ('recursos', 'Recursos', 'Enlaces, cursos y material de referencia.', 'library', 10,
   '[{"key":"url","label":"Enlace","kind":"url"},{"key":"resource_type","label":"Tipo de recurso","kind":"text"}]'::jsonb);
